...
' Hvis "Aldrig" i frm007 og "Ved ikke" er valgt
...
' Antal dage skrives i Varighed_X for periodestartdatoen
If OptionButton1.Value = True Then
    Worksheets("Regler").Range("J56:J56").Value = CInt(TextBox2.Value) - CInt(TextBox1.Value)
    Worksheets("Regler").Range("J57:J57").Value = CInt(TextBox2.Value) - CInt(TextBox1.Value)
    Worksheets("Regler").Range("J58:J58").Value = CInt(TextBox2.Value) - CInt(TextBox1.Value)
    Worksheets("Regler").Range("J59:J59").Value = CInt(TextBox2.Value) - CInt(TextBox1.Value)
    Worksheets("Regler").Range("J70:J70").Value = CInt(TextBox2.Value) - CInt(TextBox1.Value)

ElseIf OptionButton2.Value = True And (CheckBox1.Value = False And CheckBox2.Value = False) Then
    Worksheets("Regler").Range("J56:J56").Value = CInt(TextBox1.Value) + CInt(TextBox2.Value)
    Worksheets("Regler").Range("J57:J57").Value = CInt(TextBox1.Value) + CInt(TextBox2.Value)
    Worksheets("Regler").Range("J58:J58").Value = CInt(TextBox1.Value) + CInt(TextBox2.Value)
    Worksheets("Regler").Range("J59:J59").Value = CInt(TextBox1.Value) + CInt(TextBox2.Value)
    Worksheets("Regler").Range("J70:J70").Value = CInt(TextBox2.Value) + CInt(TextBox1.Value)
...
Worksheets("SpmSvar").Range("C81:C81").Value = Label3.Caption
Worksheets("SpmSvar").Range("C83:C83").Value = Label4.Caption


If OptionButton1.Value = True Then
    Worksheets("SpmSvar").Range("C82:C82").Value = Label7.Caption
Else
    Worksheets("SpmSvar").Range("C82:C82").Value = Label1.Caption
End If

If OptionButton1.Value = True Then
    Worksheets("SpmSvar").Range("D81:D81").Value = "Før det valgte stamdatafelt"
ElseIf OptionButton2.Value = True Then
    Worksheets("SpmSvar").Range("D81:D81").Value = "Samme dag eller senere end det valgte stamdatafelt"
End If

If TextBox1.Value <> "" Then
    Worksheets("SpmSvar").Range("D82:D82").Value = CInt(TextBox1.Value)
End If
    
If TextBox2.Value <> "" Then
    Worksheets("SpmSvar").Range("D83:D83").Value = CInt(TextBox2.Value)
End If

' "Ved ikke" skrives ned i arket
If CheckBox1.Value = True Then
    Worksheets("SpmSvar").Range("D82:D82").Value = "Ved ikke"
End If

If CheckBox2.Value = True Then
    Worksheets("SpmSvar").Range("D83:D83").Value = "Ved ikke"
End If
...
If CheckBox1.Value = True Or CheckBox2.Value = True Then
    dFunc.msgError = "Ved ikke knap trykket"
    SFunc.ShowFunc ("frmMsg")
End If
...
End If
    ...
    If Worksheets("SpmSvar").Range("D81:D81").Value = "Samme dag eller senere end det valgte stamdatafelt" Then
        OptionButton2.Value = True
    ElseIf Worksheets("SpmSvar").Range("D81:D81").Value = "Før det valgte stamdatafelt" Then
        OptionButton1.Value = True
    End If
    
If Worksheets("SpmSvar").Range("D82:D82").Value = "Ved ikke" Then
    CheckBox1.Value = True
Else
    TextBox1.Value = Worksheets("SpmSvar").Range("D82:D82").Value
End If



If Worksheets("SpmSvar").Range("D83:D83").Value = "Ved ikke" Then
    CheckBox2.Value = True
Else
    TextBox2.Value = Worksheets("SpmSvar").Range("D83:D83").Value
End If
