...
'If CheckBox1.Value = True Then
'    dFunc.msgError = "RIM kan ikke beregne et tidligst muligt forældelsestidspunkt for populationen."
'    SFunc.ShowFunc ("frmMsg")
'
...
'
'    'MsgBox ("RIM kan ikke beregne et tidligst muligt forældelsestidspunkt for populationen.")
'    GoTo ending
'End If
...
If OptionButton1.Value = True Then
    Worksheets("SpmSvar").Range("D92:D92").Value = "Før det valgte stamdatafelt"
...
End If
    ...
    ElseIf Worksheets("SpmSvar").Range("D92:D92").Value = "Før det valgte stamdatafelt" Then
